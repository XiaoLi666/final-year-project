...
namespace GameLogic {
	public class PathNodeGenerator : MonoBehaviour {
		...
		[SerializeField]
		private GameObject[] m_pathNodes;
		[SerializeField]
		private PathNodeGenerator.PATHNODE_TYPE[] m_pathNodeTypes;
		[SerializeField]
		private GameMap m_map; // map scriptable object
		[SerializeField]
		private Vector3 m_startLocation;
		[SerializeField]
		private Vector3 m_defaultDirection;
		[SerializeField]
		private float m_generateDistance;
		[SerializeField]
		private GENERATION_MODE m_generationMode;
		[SerializeField]
		private List<PATHNODE_TYPE> m_randomPathNodeCollection = new List<PATHNODE_TYPE>(); // list of path node types for random generation use
		[SerializeField]
		...
		[SerializeField]
		private List<Vector2> m_directionCollection = new List<Vector2>(); // collection of four direction during random generation process
